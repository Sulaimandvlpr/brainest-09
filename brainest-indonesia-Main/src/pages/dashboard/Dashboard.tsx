...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-3d via-blue-3d-light to-cyan/30 font-display">
      ...
      {/* Leaderboard dengan highlight dan medali */}
      <div className="mx-4 md:mx-12 my-8">
        <Card className="bg-blue-3d/80 text-white rounded-2xl shadow-3d">
          <CardHeader>
            <CardTitle className="text-2xl font-bold">Leaderboard Nasional</CardTitle>
            <CardDescription className="text-blue-200">Lihat peringkat Anda dibanding peserta lain</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
              <table className="min-w-full text-base">
                <thead>
                  <tr className="bg-blue-3d-light/80">
                ...
                <tbody>
                  {leaderboard.map((row, i) => (
                    <tr key={row.name} className={row.name === "Kamu" ? "bg-cyan/30 font-bold" : "hover:bg-blue-3d-light/40 transition-all"}>
